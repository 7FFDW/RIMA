...
import torch
from wsi_core.wsi_core.util_classes import Contour_Checking_fn, isInContourV1, isInContourV2, isInContourV3_Easy, isInContourV3_Hard
...
class Wsi_Region(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            print(f"WARNING: Error reading region {coord}. Skipping. Error: {e}")
            # Create a dummy black patch to prevent crashing
            patch = Image.new('RGB', self.patch_size, (0, 0, 0))
        if self.custom_downsample > 1:
